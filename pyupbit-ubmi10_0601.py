...
while True:
    try:
        ...
        if Trading_start == 1:
        ...
        elif Trading_start == 2:
            ref_price = []
            limit_price = []
            crypto_hold = [] * crypto_cnt
            crypto_balance = []
            ...
            elif limit_price[idx] > cur_price:
            ...
            elif crypto_hold[idx] == 0 and ref_price[idx] > cur_price:
                if cur_balance > (min_krw / cur_price):
                    upbit.sell_market_order(crypto_krw[idx], cur_balance * 0.9995)
        ...
        if (now.hour == 1 or now.hour == 5 or now.hour == 9 or now.hour == 13 or now.hour == 17 or now.hour == 21) and now.minute == 00 and now.second >= 00 and now.second <= 19: Trading_start = 2
        time.sleep(1)
