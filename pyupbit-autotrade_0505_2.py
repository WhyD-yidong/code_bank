...
while True:
    try:
        ...
        if CNT_index == 1: #BTC check
            ...
            crypto_print("BTC cur:", BTC_cur_price)
            btc = get_balance("BTC")
            btc_krw = btc * BTC_cur_price
            crypto_print("BTC balance:", btc, "BTC at KRW:", btc_krw)
            ...
            crypto_print("ETH cur:", ETH_cur_price)
            eth = get_balance("ETH")
            eth_krw = eth * ETH_cur_price
            crypto_print("ETH balance:", eth, "ETH at KRW:", eth_krw)
            ...
            crypto_print("XRP cur:", XRP_cur_price)
            xrp = get_balance("XRP")
            xrp_krw = xrp * XRP_cur_price
            crypto_print("XRP balance:", xrp, "XRP at KRW:", xrp_krw)
            ...
            crypto_print("DOGE cur:", DOGE_cur_price)
            doge = get_balance("DOGE")
            doge_krw = doge * DOGE_cur_price
            crypto_print("DOGE balance:", doge, "DOGE at KRW:", doge_krw)
